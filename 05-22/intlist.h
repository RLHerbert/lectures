...
private:
    ...
    int countHelper( Node * head) const;
    int sumHelper(Node *head) const;                 // sum of all values
    bool containsHelper(Node *head, int value) const;  // true if value in list
    int maxHelper(Node *head) const;                 // maximum value
